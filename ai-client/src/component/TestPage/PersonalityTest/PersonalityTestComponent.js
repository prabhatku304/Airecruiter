    ...
    <>
      <div class="container">
        ...
        <ol>
          ...
          <li>
            <strong>In judging others are you more swayed by:</strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            <strong>Does it bother you more having things:</strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            ...
            <div class="radio">
              <label>
                ...
                Keep abr /east of other’s happenings
              </label>
            </div>
            <div class="radio">
              <label>
          ...
          <li>
            <strong>In doing ordinary things are you more likely to:</strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            <strong>Are you more comfortable in making:</strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            ...
            <div class="radio">
              <label>
                <input type="radio" name="q25" value="t" />a cool-headed person
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" name="q25" value="f" />a warm-hearted person
              </label>
            </div>
          </li>
          ...
          <li>
            <strong>Should one usually let events occur:</strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            <strong>Does new and non-routine interaction:</strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            ...
            <div class="radio">
              <label>
                <input type="radio" name="q37" value="s" />a practical sort of
                person
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" name="q37" value="n" />a fanciful sort of
                person
              </label>
            </div>
          </li>
          ...
          <li>
            <strong>Are you more comfortable with work that:</strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            ...
            <div class="radio">
              <label>
                ...
                many friends with br /ief contact
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" name="q43" value="i" />a few friends with
          ...
          <li>
            <strong>Do you value in /yourself more that you are:</strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            <strong>Are you more likely to trust your:</strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            <strong>
              Which person is more to be complimented &ndash; one of:
            </strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            <strong>In relationships should most things be:</strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            ...
            <div class="radio">
              <label>
                <input type="radio" name="q58" value="s" />a strong sense of
                reality
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" name="q58" value="n" />a vivid imagination
              </label>
            </div>
          </li>
          ...
          <li>
            <strong>Which situation appeals to you more:</strong>
            <br />
            <div class="radio">
              <label>
          ...
          <li>
            <strong>Which do you wish more for yourself:</strong>
            <br />
            <div class="radio">
              <label>
        ...
        <p id="scroll-down" class="hidden text-center">
          (<i>scroll down</i>)
        </p>
        <p class="text-center">
          <button
