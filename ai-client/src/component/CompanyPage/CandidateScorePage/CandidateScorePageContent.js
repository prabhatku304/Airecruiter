          ...
          <div className="">
            ...
            <div className="d-flex justify-content-between mt-5">
              ...
              <p>
                Interview Status:{" "}
                <span style={{ color: "blue" }}>
                  {props.data.is_interview_completed ? (
                    <>Completed</>
                  ) : (
                    <>Not Completed</>
                  )}
                ...
                <>
                  <div className="">
                    <button
                      ...
                      onClick={() => props.onCandidateSelection(true)}
                    >
                      Select Candidate
                      <i className="l-icon fa fa-thumbs-up ml-2"></i>
                    </button>
                  </div>
                  <div className="">
                    <button
                      className="btn btn-danger"
                      onClick={() => props.onCandidateSelection(false)}
                    >
                      Reject Candidate
                      <i className="l-icon fa fa-thumbs-down ml-2"></i>
                    </button>
                  </div>
                </>
              )}
